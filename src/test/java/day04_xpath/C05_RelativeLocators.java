...
public class C05_RelativeLocators {
    public static void main(String[] args) {
        ...
        //london'in sagi, berlin solu seklinde tarif edelim
        ...
        WebElement boston1= driver.findElement(RelativeLocator
                ...
                .toRightOf(london)
                .toLeftOf(berlin));
        System.out.println(boston1.getAttribute("id"));

        //toronto alti diyelim
        ...
        WebElement boston2=driver.findElement(RelativeLocator
                ...
                .below(toronto));
        System.out.println(boston2.getAttribute("id"));
